									...
									<div className="col-12 col-lg-4">
										<div className="h8-about-left">
											<span
												...
												data-wow-delay=".3s"
											>
												<i className="tji-box"></i>About Azania Bank
											</span>
										</div>
									</div>
									<div className="col-12 col-lg-8">
										<div className="h8-about-content-inner">
											<h2 className="sec-title title-highlight">
												We are committed to helping individuals and businesses
												achieve their financial goals through trusted service,
											...
											<div className="h8-about-item h8-about-item-desc">
												<div className="h8-about-item-content">
													...
													<div
														...
														data-wow-delay="1s"
													>
														<ButtonPrimary text={"Learn More"} url={"/about-azania-bank"} />
													</div>
												</div>
											</div>
										</div>
